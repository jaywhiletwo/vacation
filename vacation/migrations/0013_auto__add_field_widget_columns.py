...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Widget.columns'
        db.add_column('vacation_widget', 'columns',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Widget.columns'
        db.delete_column('vacation_widget', 'columns')
    ...
    models = {
        ...
        'vacation.widget': {
            ...
            'columns': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
