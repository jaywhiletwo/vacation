...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WidgetPick.head_color'
        db.add_column('vacation_widgetpick', 'head_color',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WidgetPick.body_color'
        db.add_column('vacation_widgetpick', 'body_color',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetPick.head_color'
        db.delete_column('vacation_widgetpick', 'head_color')

        # Deleting field 'WidgetPick.body_color'
        db.delete_column('vacation_widgetpick', 'body_color')
    ...
    models = {
        ...
        'vacation.widgetpick': {
            ...
            'body_color': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'head_color': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
