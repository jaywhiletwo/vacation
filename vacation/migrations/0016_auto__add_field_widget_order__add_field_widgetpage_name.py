...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Widget.order'
        db.add_column('vacation_widget', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WidgetPage.name'
        db.add_column('vacation_widgetpage', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Widget.order'
        db.delete_column('vacation_widget', 'order')

        # Deleting field 'WidgetPage.name'
        db.delete_column('vacation_widgetpage', 'name')
