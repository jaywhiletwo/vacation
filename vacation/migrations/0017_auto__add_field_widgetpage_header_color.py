...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WidgetPage.header_color'
        db.add_column('vacation_widgetpage', 'header_color',
                      self.gf('django.db.models.fields.CharField')(default='black', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetPage.header_color'
        db.delete_column('vacation_widgetpage', 'header_color')
