...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WidgetPage.banner_image'
        db.add_column('vacation_widgetpage', 'banner_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vacation.Image'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WidgetPage.banner_image'
        db.delete_column('vacation_widgetpage', 'banner_image_id')
