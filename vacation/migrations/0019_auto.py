...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field pages on 'Widget'
        m2m_table_name = db.shorten_name('vacation_widget_pages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('widget', models.ForeignKey(orm['vacation.widget'], null=False)),
            ('widgetpage', models.ForeignKey(orm['vacation.widgetpage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['widget_id', 'widgetpage_id'])


    def backwards(self, orm):
        # Removing M2M table for field pages on 'Widget'
        db.delete_table(db.shorten_name('vacation_widget_pages'))
    ...
    models = {
        ...
        'vacation.widget': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_page'", 'null': 'True', 'to': "orm['vacation.WidgetPage']"}),
            'pages': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['vacation.WidgetPage']", 'symmetrical': 'False'}),
        ...
        'vacation.widgetpage': {
            ...
            'banner_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vacation.Image']", 'null': 'True', 'blank': 'True'}),
            'header_color': ('django.db.models.fields.CharField', [], {'default': "'black'", 'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
